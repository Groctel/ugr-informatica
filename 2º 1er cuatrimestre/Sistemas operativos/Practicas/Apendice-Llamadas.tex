...
\subsection{\code{clone}}\label{clone}
...
\subsection{\code{fcntl}}\label{fcntl}
...
\subsection{\code{kill}}\label{kill}
...
\subsection{\code{mkfifo}}\label{mkfifo}
...
\subsection{\code{mknod}}\label{mknod}
...
\subsection{\code{pipe}}\label{pipe}
...
\subsection{\code{sigaction}}\label{sigaction}
...
\subsection{\code{sigpending}}\label{sigpending}
...
\subsection{\code{sigprocmask}}\label{sigprocmask}
...
\subsection{\code{sigsuspend}}\label{sigsuspend}
...
\subsection{\code{unlink}}\label{unlink}
...
\subsection{\code{wait}}\label{wait}
