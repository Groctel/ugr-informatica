\chapter{Herramientas de programación paralela II\@: Cláusulas OpenMP}\label{clausulas-openmp}
...
\end{tabular}
\end{center}
\caption{Valores de inicialización para los operadores de la cláusula \code{reduction}}\label{clausulas-omp-reduction-valores-inicializacion}
\end{table}
