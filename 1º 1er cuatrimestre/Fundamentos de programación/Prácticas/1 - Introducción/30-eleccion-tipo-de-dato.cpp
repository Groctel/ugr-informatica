...
int main ()
{
	...
	const bool ES_HOMBRE = false;
	const int EDAD = 20;
	const double PIB = 1166.3;

	std::cout
		<< "Para la edad hemos usado un 'int': " << EDAD << std::endl
		<< "Para el pib hemos usado un 'double': " << PIB << std::endl
		<< "Para la primalidad hemos usado un 'bool': " << ES_PRIMO << std::endl
		<< "Para el sexo también hemos usado un 'bool': " << ES_HOMBRE << std::endl
