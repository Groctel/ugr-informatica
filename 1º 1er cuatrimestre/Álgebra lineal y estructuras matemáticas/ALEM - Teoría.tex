...
\chapter{Números naturales y números enteros}\label{numeros-naturales-y-numeros-enteros}
	...
	\input{Teoría/Números enteros.tex}
	\input{Teoría/Divisibilidad.tex}
	\input{Teoría/Números primos.tex}
	\input{Teoría/Clases residuales módulo m.tex}
	\input{Teoría/Sistemas de congruencias.tex}
	\input{Teoría/Ecuaciones diofánticas.tex}

\chapter{Cuerpos finitos}\label{cuerpos-finitos}
	\input{Teoría/Cuerpos finitos definición.tex}
	\input{Teoría/Generalidades sobre polinomios.tex}

\chapter{Combinatoria}\label{combinatoria}
	\input{Teoría/Métodos elementales de conteo.tex}
	\input{Teoría/Agrupaciones.tex}
	\input{Teoría/Números combinatorios.tex}

\chapter{Matrices, sistemas de ecuaciones y determinantes}\label{matrices-sistemas-de-ecuaciones-y-determinantes}
	\input{Teoría/Matrices.tex}
	\input{Teoría/Sistemas de ecuaciones lineales.tex}
